...
Route::prefix("$panel")->group(function()
{
    ...
    Route::post('/settings/iprotate',[SettingsController::class,'iprotate_save'])->name('settings.iprotate');
    Route::get('/settings/iprotate/delete/{id}',[SettingsController::class,'iprotate_delete'])->name('settings.iprotate.delete');
    Route::get('/settings/iprotate/now/{id}',[SettingsController::class,'iprotate_now'])->name('settings.iprotate.now');
    Route::post('/settings/serverip',[SettingsController::class,'serverip_save'])->name('settings.serverip');
    Route::get('/settings/serverip/run',[SettingsController::class,'serverip_run'])->name('settings.serverip.run');
    Route::post('/settings/autobackup',[SettingsController::class,'autobackup_save'])->name('settings.autobackup');
    Route::get('/settings/autobackup/run',[SettingsController::class,'autobackup_run'])->name('settings.autobackup.run');
...
Route::prefix('api')->group(function()
{
    ...
    Route::get('/{token}/link/ssh/{type}/{username}',[ApiController::class,'link_ssh'])->name('api.link.ssh');
    Route::get('/{token}/link/npv/{type}/{username}',[ApiController::class,'link_npv'])->name('api.link.npv');
    Route::get('/{token}/links/{username}',[ApiController::class,'link_all'])->name('api.link.all');
...
Route::prefix('fixer')->group(function() {
    ...
    Route::get('/rotateip', [FixerController::class, 'rotate_ip'])->name('rotateip');
});
Auth::routes();
