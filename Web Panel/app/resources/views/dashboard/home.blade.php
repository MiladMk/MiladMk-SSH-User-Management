...
@section('title','MiladMk - '.__('dashboard-title'))
@section('content')
        ...
        <div class="pc-content">
            ...
            <div class="row">
                @if(env('APP_LOCALE') == 'fa')
                    @php
                        $json = @file_get_contents('https://raw.githubusercontent.com/MiladMk/MiladMk-SSH-User-Management/main/version.json');
                        $obj = $json ? json_decode($json) : null;
                        $github='https://github.com/MiladMk/MiladMk-SSH-User-Management/blob/main/README.md#installation-guide';
                    @endphp
                @elseif(env('APP_LOCALE') == 'en')
                    @php
                        $json = @file_get_contents('https://raw.githubusercontent.com/MiladMk/MiladMk-SSH-User-Management/main/version.json');
                        $obj = $json ? json_decode($json) : null;
                        $github='https://github.com/MiladMk/MiladMk-SSH-User-Management/blob/main/README-EN.md#installation-guide';
                    @endphp
                @elseif(env('APP_LOCALE') == 'ru')
                    @php
                        $json = @file_get_contents('https://raw.githubusercontent.com/MiladMk/MiladMk-SSH-User-Management/main/version.json');
                        $obj = $json ? json_decode($json) : null;
                        $github='https://github.com/MiladMk/MiladMk-SSH-User-Management/blob/main/README-RU.md#installation-guide';
                    @endphp
                @endif
                @if($obj && isset($obj->last_version) && $obj->last_version>400)
