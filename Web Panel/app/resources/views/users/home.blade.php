...
@section('title','MiladMk - '.__('user-title'))
@section('content')
    <!-- [ Main Content ] start -->
    ...
    return "sn://ssh?" . $base64_urlsafe;
                                            ...
                                            // NPV Tunnel link generator (npvt-ssh://<base64 json>)
                                            function npvtunnel_link_generator(string $configType, string $host, int $port, string $username, string $password, string $remarks = '', int $udpgwPort = 7300): string {
    $config = [
        "sshConfigType"        => $configType,
        "remarks"              => $remarks !== '' ? $remarks : $username,
        "sshHost"              => $host,
        "sshPort"              => $port,
...
{{$st_date}}&nbsp;{{$en_date}}">{{__('user-table-copy')}}
                                                                ...
                                                                <a href="javascript:void(0);" class="dropdown-item copy-txt"
                                                                   style="border:none"
                                                                   data-clipboard="true"
                                                                   data-clipboard-text="{{ npvtunnel_link_generator('SSH-Direct',$websiteaddress,(int)$port_ssh,$user->username,$user->password,$user->username,(int)env('PORT_UDPGW',7300)) }}">{{__('user-table-link')}}
                                                                    NPV Tunnel (Direct)
                                                                </a>
                                                                ...
                                                                <a href="javascript:void(0);" class="dropdown-item copy-txt"
                                                                   style="border:none"
                                                                   data-clipboard="true"
                                                                   data-clipboard-text="{{ npvtunnel_link_generator('SSH-Direct',$websiteaddress,(int)$tls_port,$user->username,$user->password,$user->username,(int)env('PORT_UDPGW',7300)) }}">{{__('user-table-link')}}
                                                                    NPV Tunnel (TLS)
                                                                </a>
                                                                ...
                                                                <a href="javascript:void(0);" class="dropdown-item copy-txt"
                                                                   style="border:none"
                                                                   data-clipboard="true"
                                                                   data-clipboard-text="{{ npvtunnel_link_generator('SSH-Direct',$websiteaddress,(int)env('PORT_DROPBEAR'),$user->username,$user->password,$user->username,(int)env('PORT_UDPGW',7300)) }}">{{__('user-table-link')}}
                                                                    NPV Tunnel (Dropbear)
                                                                </a>
