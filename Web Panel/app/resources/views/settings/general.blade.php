...
@section('title','MiladMk - '.__('setting-general-title'))
@section('content')
    <!-- [ Main Content ] start -->
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <input type="text" name="custom_host" class="form-control" placeholder="example.com" value="{{env('CUSTOM_HOST')}}">
                                                <small>{{__('setting-general-custom-host')}}</small>
                                            </div>
                                        </div>
