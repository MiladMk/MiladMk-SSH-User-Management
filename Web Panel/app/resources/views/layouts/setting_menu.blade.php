<div class="card-body border-bottom pb-0">
    <ul class="nav nav-tabs analytics-tab" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a href="https://github.com/MiladMk/MiladMk-SSH-User-Management" target="_blank" class="nav-link" type="button" role="tab" aria-selected="false" tabindex="-1"><i class="ti ti-box-multiple"></i>&nbsp;&nbsp;{{__('setting-multiserver-menu')}}</a>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <a href="iprotate" class="nav-link {{ request()->segment(3) === 'iprotate' ? 'active' : '' }}" type="button" role="tab" aria-selected="false" tabindex="-1"><i class="ti ti-refresh"></i>&nbsp;&nbsp;{{__('setting-iprotate-menu')}} </a>
            <a href="serverip" class="nav-link {{ request()->segment(3) === 'serverip' ? 'active' : '' }}" type="button" role="tab" aria-selected="false" tabindex="-1"><i class="ti ti-server-bolt"></i>&nbsp;&nbsp;{{__('setting-serverip-menu')}} </a>
            <a href="autobackup" class="nav-link {{ request()->segment(3) === 'autobackup' ? 'active' : '' }}" type="button" role="tab" aria-selected="false" tabindex="-1"><i class="ti ti-cloud-upload"></i>&nbsp;&nbsp;{{__('setting-autobackup-menu')}} </a>
        </li>
        <li class="nav-item" role="presentation">
