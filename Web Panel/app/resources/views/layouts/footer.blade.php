        ...
        <div class="row">
            ...
            <div class="col-auto my-1">
                <ul class="list-inline footer-link mb-0">
                    ...
                    <li class="list-inline-item"><a href="https://github.com/MiladMk/MiladMk-SSH-User-Management/blob/main/README-EN.md#supporting-us-hearts">Supporting us</a></li>
                    <li class="list-inline-item"><a href="https://github.com/MiladMk/MiladMk-SSH-User-Management/">GitHub</a></li>
                </ul>
            </div>
        </div>
    </div>
