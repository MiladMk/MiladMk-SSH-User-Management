    ...
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="#" class="b-brand text-primary">
                ...
                <img src="/assets/images/xlogo.png" alt="MiladMk" style="width:50px"/>
    ...
    <div class="header-wrapper"> <!-- [Mobile Media Block] start -->
        ...
        <div class="ms-auto">
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item">
                    <a href="https://github.com/MiladMk/MiladMk-SSH-User-Management" target="_blank">
                        <img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/MiladMk/MiladMk-SSH-User-Management?style=social&link=left">
                    </a>
                </li>
                <li class="dropdown pc-h-item">
